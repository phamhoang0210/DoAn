...
$(document).ready(function() {
    ...
    $('#fitness1-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    $('#fitness2-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    "columnDefs": [ {
      ...
      "orderable": false,
         ...
         //Hung sắp xếp theo ngày- lớn - nhỏ targets: [ 0 ], orderSequence: [ "desc", "desc", "asc" ];
          // { "orderSequence": [ "asc" ] },
    ...
    $('#fitness3-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    $('#fitness4-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    $('#fitness5-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    $('#fitness6-table_new').on('click', function(e) {
        e.preventDefault();
    ...
    $('#fitness7-table_new').on('click', function(e) {
        e.preventDefault();
