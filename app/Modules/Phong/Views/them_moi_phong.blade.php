      ...
      <div class="container-fluid">
        ...
        <div class="add_loaitin">
                ...
                @if(session('error2'))
                 ...
                 @endif
                <form action="{{url('admincp/phong/them_moi_phong')}}" class="ng-pristine ng-valid" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                            ...
                            <div class="col-xs-12 col-md-6">
                             ...
                             <div class="col-xs-12 col-md-6">
                                  ...
                                  <label class="radio-inline">
                                      <input type="radio" name="iTrangthai" value="1">Còn phòng
                                  </label>
                                  <label class="radio-inline">
                                      <input type="radio" name="iTrangthai" value="0">hết phòng
                                  </label>
                                  </p>       
                          </div>
                            </div>  
                    ...
                    <div class="row" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="col-md-12">
                                    <button class="btn btn-info" onclick="return confirm('Bạn có muốn thêm không?')">
                                      Thêm mới
                                    </button>
