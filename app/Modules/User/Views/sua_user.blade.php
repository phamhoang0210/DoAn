    ...
    @section('content')
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('admincp/user/sua-user')}}" class="activated">Sửa User</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i> Sửa User
                            </h4>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form id="add_users_form" action="{{ url('admincp/user/user_capnhat'.'/'.$user->id) }}" method="post" class="form-horizontal">
                                            <div class="form-body">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input value="{{ $user->sTen }}" type="text" class="form-control" name="name">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            if ((($user->FK_IDLoaitaikhoan==1)&&($user->id==Auth::user()->id))||($user->FK_IDLoaitaikhoan!=1)){
                            ?>                             
                             ...
                             <label class="col-md-3 control-label" for="usr_name">
                                   ...
                                   <select class="form-control" name="user_type_id">
									<?php for ($i=0; $i<count($user_types);$i++){ ?>
                                        <option value="{{ $user_types[$i]->id }}" 
                                         <?php if ($user->FK_IDLoaitaikhoan == $user_types[$i]->id) echo 'selected="selected"';?> >{{ $user_types[$i]->sTen }}</option>
										 <?php } ?>
									</select>			      
                                        </div>
                                    </div>
