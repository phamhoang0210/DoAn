      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i> Sửa dịch vụ
                    </h4>
        ...
        <div class="add_loaitin">
                ...
                @if(session('error2'))
                 ...
                 @endif
        <h4 style="padding-top: 20px;">Sửa dịch vụ:</h4>
                <form action="{{url('admincp/dichvu/sua_dich_vu/'.$dichvu[0]->id)}}" class="ng-pristine ng-valid" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="row">
                             <div class="col-xs-12 col-md-6">
                                <div class="form-group">                     
                                       <lable for="sel1">Tên dịch vụ:</lable>
                                       <input type="text" name="sTenDV" value="{{$dichvu[0]->sTenDV}}"class="form-control input-sm" placeholder="Loại phòng...">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">                     
                                       ...
                                       <input type="text" style="color:red;" name="iDongia" value="{{$dichvu[0]->iDongia}}" class="form-control input-sm" placeholder="250.000 VND">
                                </div>
                            </div>    
                    </div>
                    <div class="row">
                         <div class="col-xs-12 col-md-12">
                               <div class="form-group">
                                  <label>Mô tả:</label>
                                  <label>service</label>
                                  <textarea name="sMota" style="text-align: left;" row="2" class="form-control" placeholder="Mô tả loại phòng khách sạn">
                                    {{$dichvu[0]->sMota}}
                                  </textarea>
                               </div>
                           </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group">                       
                                  ...
                                  <p>
                                    <img src="/upload/images/{{$dichvu[0]->sHinhanh}}" width="200px">
                                    {{$dichvu[0]->sHinhanh}}  
                                  </p>
