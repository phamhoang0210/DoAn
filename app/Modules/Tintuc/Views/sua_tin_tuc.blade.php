...
<body>
    ...
    @section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i> Sửa tin tức
                    </h4>
        ...
        <div class="add_tintuc">
                ...
                <form action="{{url('admincp/tintuc/sua_tin_tuc/'.$tintuc[0]->id)}}" class="ng-pristine ng-valid" method="post" enctype="multipart/form-data">
                         ...
                         <div class="row">
                             <div class="col-xs-12 col-md-12">
                                <div class="form-group">                     
                                       <lable>Tên:</lable>
                                       <input type="text" name="sTieude" value="{{$tintuc[0]->sTieude}}" class="form-control input-sm" placeholder="tiêu đề">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group">
                              <label>Tóm tắt nội dung:</label>
                                  <label>Content</label>
                                  <textarea name="sTomtat" row="5" class="form-control">
                                  	{{$tintuc[0]->sTomtat}} 
                                  </textarea>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group">                       
                                  ...
                                  <textarea name="sNoidung" class="form-control" id="editor1">
                                  	{{$tintuc[0]->sNoidung}};
                                  </textarea>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group">                       
                                  ...
                                  <img width="200px" src="/upload/images/{{$tintuc[0]->sHinhanh}}"> 
                        ...
                        <div class="col-xs-12 col-md-6">
                          <div class="form-group">                       
                                  ...
                                  <label class="radio-inline">
                                      <input 
                                       @if($tintuc[0]->iNoibat==1)
                                       {{"checked"}}
                                       @endif
                                       type="radio" name="iNoibat" value="1">Nổi bật
                                  </label>
                                  <label class="radio-inline">
                                      <input 
                                       @if($tintuc[0]->iNoibat==0)
                                       {{"checked"}}
                                       @endif
                                      type="radio" name="iNoibat" value="0">Không nổi bật
                                  </label>       
                          </div>
                        </div>
                    </div>
