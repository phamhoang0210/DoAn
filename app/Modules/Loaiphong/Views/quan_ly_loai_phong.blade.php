    ...
    @section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="add_loaitin">
                ...
                <form action="{{url('admincp/loaiphong/quan_ly_loai_phong')}}" class="ng-pristine ng-valid" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="row">
                             <div class="col-xs-12 col-md-6">
                                <div class="form-group">                     
                                       <lable for="sel1">Tên Loại phòng:</lable>
                                       <input type="text" name="sTenLP" class="form-control input-sm" placeholder="Loại phòng...">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">                     
                                       ...
                                       <input type="text" name="iGiaphong" class="form-control input-sm" placeholder="250.000">
                                </div>
                            </div>    
                    </div>
                    <div class="row">
        ...
        <div class="border">
              <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Chi tiết Loại tin</h4>
              </div>
        </div><!--border-->
            ...
            <tbody>
                ...
                @foreach($loaiphong as $value)
                  <tr>
                    ...
                    <td>{{$value->sMota}}</td>
                    <td>{{$value->iGiaphong}}</td>
                    <td>
                    <a href="{{url('admincp/loaiphong/sua_loai_phong/'.$value->id)}}" data-toggle="tooltip" data-placement="left" class="btn btn-success" data-original-title="SỬA"><i class="fa fa-pencil-square-o fa-lg"></i>
                    </a>
                    <a href="{{url('admincp/loaiphong/delete_loaiphong/'.$value->id)}}" data-toggle="tooltip" data-placement="left" class="btn  btn-danger" data-original-title="Xóa" onclick="return confirm('Bạn có muốn xóa không?')"><i class="fa fa-times fa-lg" aria-hidden="true"></i>
                    </a>
                    </td>
                  </tr>
                @endforeach
